...
QString InventoryReportService::documentTypeName(const QString &documentType)
{
    ...
    if (type == QStringLiteral("WXLY")) return QStringLiteral("售后领料");
    if (type == QStringLiteral("YPLY")) return QStringLiteral("研发领料");
    if (type == QStringLiteral("QTCK")) return QStringLiteral("其他领料");
